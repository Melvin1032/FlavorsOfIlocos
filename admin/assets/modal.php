                ...
                foreach ($result as $row) {
                    ...
                    <div class="card" style="width:185px; height:200px; margin: 20px">
                        <div class="d-flex justify-content-center align-items-center" style="max-height: 120px;">
                            <img  src="http://localhost/Flavors of Ilocos/uploads/<?php echo $recipeImage ?>" class="card-img-top mt-1" alt="Recipe" style="max-width: 120px; max-height: 180px;">
                        </div>
                        <div class="card-body">
...
<div class="modal fade mt-5" id="viewRecipeModal" tabindex="-1" aria-labelledby="viewRecipe" aria-hidden="true">
    <div class="modal-dialog modal-xl" style="margin-top: 1rem;">
        <div class="modal-content">

        
            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="viewRecipe"><strong>Recipe Details</strong></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <div class="text-center mt-4">
                    <button type="button" class="btn btn-info btn-sm fs-3" onclick="printRecipe()">Print Recipe</button>
                </div>
            ...
            <div class="modal-body">
                ...
                <!-- Recipe Image and Name Section -->
                <div class="text-center mb-4">
                    <img src="" id="viewRecipeImage" class="img-fluid" alt="Recipe Image" style="max-width: 400px;">
                </div>
                <div class="text-center mb-3">
                    <h4 class="font-weight-bold" id="viewRecipeName"></h4>
                    <p class="text-muted">Category: <span id="viewCategoryName"></span></p>
                </div>

                <!-- Ingredients and Procedure Section -->
                <div class="mb-3" style="padding-left: 5rem; padding-right: 5rem;">
                    <h5 class="font-weight-bold">Ingredients:</h5>
                    <p id="viewRecipeIngredients" class="text-muted"></p>
                </div>
                <div class="mb-3" style="padding-left: 5rem; padding-right: 5rem;">
                    <h5 class="font-weight-bold ">Procedure:</h5>
                    <p id="viewRecipeProcedure" class="text-muted"></p>
                </div>
