...
<head>
   ...
   <link rel="stylesheet" href="/Flavors of Ilocos/css/header_user.css">
...
<div class="top-bar">
    ...
    <nav>
            <div class="logo">
               <a href="home_admin.php"> <img src="/Flavors of Ilocos/logo/Logo5.png" alt="Logo"> </a>
            </div>
        <div class="toggle"><i class='bx bx-menu'></i></div>
        <ul class="menu">
            <li><a href="home_admin.php">Home</a></li>
            <li><a href="recipes_admin.php">Recipes</a></li>
